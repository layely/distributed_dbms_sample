...
#map{
    ...
    <header class="site-header box-white padding-all clearfix">
        ...
        <div class="header-menu">
            ...
            <ul class="clearfix">
  <li clas="active"><a href="index.php">Accueil</a>
  </li>
...
<div class='row'>
    ...
    <label for="bain" class="col-sm-4 control-label">la localisation de l'appartement<br> <i id="latitude"><%=request.getParameter("latitude") %></i>
    <br><i id="longitude"><%=request.getParameter("longitude") %></i></label>
    <i id="latitude"><%=request.getParameter("latitude") %></i>
    <i id="longitude"><%=request.getParameter("longitude") %></i>
