...
#map{
  ...
  <li><a href="#">Nos Logement</a>
    <ul>
      <li><a href="appartement.jsp">Appartement </a></li>
      <li><a href="batiment.jsp">Batiment</a></li>
      
    </ul>
  </li>
  <li ><a href="ajout.jsp">Ajouter logement</a>
  </li>
...
<div class="row">
    ...
    while(result.next()){
    	out.print(result.getString("latitude"));
    	out.print("gd");
    }
    }catch(Exception e){
    	e.printStackTrace();
    }
    ArrayList<Logement> listLogement= new ArrayList<Logement>(); 
    	Logement logement= new Logement();
    	logement.setType("batiment");
    	logement.setPrix(200000);
    	logement.setLatitude("14.152301");
    	logement.setLongitude("-17.98236");
    	logement.setNombreBain(8);
    	logement.setNombreChambre(15);
    	logement.setNombreSalon(12);
    	Logement logement1= new Logement();
    	logement1.setType("batiment");
    	logement1.setPrix(150000);
    	logement1.setLatitude("12.01452");
    	logement1.setLongitude("-17.123652");
    	logement1.setNombreBain(2);
    	logement1.setNombreChambre(1);
    	logement1.setNombreSalon(5);
     ...
     <div class="col-sm-6">
        <div class="collection-item box-grey">
            ...
            <div class="collection-desc">
                type  : <%out.print(listLogement.get(1).getType()); %><br />
                A partir de <%out.print(listLogement.get(1).getPrix()); %>
                 Fcfa.<br />
                 Il comport    :<br>
                 <%out.print(listLogement.get(1).getNombreChambre()); %> Chambre
                <%out.print(listLogement.get(1).getNombreBain()); %> avec Salle de Bain<br>
                <%out.print(listLogement.get(1).getNombreSalon()); %> sallon<br>
                <i id="latitude"><%=listLogement.get(1).getLatitude() %></i>
                <i id="longitude"><%=listLogement.get(1).getLongitude() %></i>
            </div>
        </div>
    </div>
