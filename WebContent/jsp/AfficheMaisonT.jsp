        ...
        <body>
            <div class='container'>
                ...
                <div class='row'>
                    ...
                    <label  class="col-sm-6 control-label"><%= new MaisonDAO().listMaisonT().get(i).getPrix()%> </label>
                </div>
                <div class='row'>
                    <label  class="col-sm-6 control-label">Son addresse est  </label>
                    <label  class="col-sm-6 control-label"><%= new MaisonDAO().listMaisonT().get(i).getAddress()%> </label>
                </div>
                <div class='row'>
                    <label  class="col-sm-6 control-label">Elle a etait construit en  </label>
                    <label  class="col-sm-6 control-label"><%= new MaisonDAO().listMaisonT().get(i).getDateConstruction()%> </label>
                </div>
                <div class='row'>
