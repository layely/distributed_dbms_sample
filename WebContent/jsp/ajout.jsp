...
<div class='row'>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="chambre" name="nombreChambre" placeholder="numb chambre">
    </div>
  </div>
   <div class="form-group">
    <label for="salon" class="col-sm-4 control-label">entrer le nombre de salon</label>
    <div class="col-sm-8">
      <input type="text" class="form-control" id="salon" name="nombreSalon" placeholder="numb salon">
    </div>
    </div>
     <div class="form-group">
    <label for="bain" class="col-sm-4 control-label">entrer le nombre de salle de bain</label>
    <div class="col-sm-8">
      <input type="text" class="form-control" id="bain" name="nombreBain" placeholder="Salle de bain">
    </div>
  </div>
  <div class="form-group">
    <label for="bain" class="col-sm-4 control-label">entrer les coordonnée du logement</label>
    <div class="col-sm-8">
         <div class="form-group">
            <label for="latitude" class="col-sm-4 control-label">latutude</label>
            <div class="col-sm-4">
         ...
         <div class="form-group">
            ...
            <button type="button" class="btn btn-info col-sm-4" id ="valider" >Valider</button>
         </div>
